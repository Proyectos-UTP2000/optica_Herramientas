...
public final class OpcionCatalog {
    ...
    public static List<OpcionDefinition> definiciones() {
        return List.of(
            new OpcionDefinition("Dashboard", "/", "IconDashboard",1, null, true, true),
            new OpcionDefinition("Administración", null, "IconPerfiles", 10, null, true, true),
            new OpcionDefinition("Clientes y Ventas", null, "IconClientes", 20, null, true, true),
            ...
            new OpcionDefinition("Configuración Menú", "/configuracion-menu", "IconConfig", 3, "Administración", true, true),
            ...
            new OpcionDefinition("Caja", "/reportes/caja", "IconDashboard", 1, "Reportes", true, true),
            new OpcionDefinition("Kardex", "/reportes/kardex", "IconInventario", 2, "Reportes", true, true),
            new OpcionDefinition("Ventas", "/reportes/ventas", "IconVentas", 3, "Reportes", true, true),
    ...
    public record OpcionDefinition(String nombre, String ruta, String icono, Integer orden, String padreNombre,
            boolean visibleEnMenu, boolean asignarAdministrador) {
    }
}
