...
const ModalEditarProducto = ({ producto, cerrarModal, recargarTabla }) => {
  ...
  const [imagenPreview, setImagenPreview] = useState(producto?.imagenes?.length > 0 ? producto.imagenes[0].rutaImagen : null);
  ...
  const handleGuardar = async () => {
    ...
    const productoData = {
      ...
      idEtiquetas: producto?.etiquetas ? producto.etiquetas.map(e => e.id) : [],
