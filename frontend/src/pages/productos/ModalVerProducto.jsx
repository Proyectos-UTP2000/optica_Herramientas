...
const ModalVerProducto = ({ producto, cerrarModal }) => {
  const imagenUrl =
    producto?.imagenes?.length > 0 ? producto.imagenes[0].rutaImagen : null;
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: "250px" }}>
          ...
          <p
            style={{ margin: "0 0 12px 0", fontSize: "12px", color: "#64748b" }}
          >
            <b>SKU:</b> {producto.codigo || "Sin SKU"} | <b>Modelo:</b>{" "}
      ...
      <div className="form-grid" style={{ gap: "15px", marginBottom: "15px" }}>
        <div>
          <span
            style={{ fontSize: "12px", color: "#64748b", display: "block" }}
          >
            Costo Compra
          </span>
          <strong style={{ fontSize: "15px", color: "#0f172a" }}>
            S/. {producto.costo?.toFixed(2)}
          </strong>
        </div>
        <div>
          <span
        ...
        <div>
          ...
          <strong
            style={{
              fontSize: "15px",
              color:
                producto.stock <= producto.stockMinimo ? "#ef4444" : "#10b981",
            }}
          >
        ...
        <div>
          ...
          <strong style={{ fontSize: "15px", color: "#ef4444" }}>
            {producto.stockMinimo} {producto.unidadVentaNombre}
          </strong>
        </div>
      </div>
      ...
      <div className="form-grid" style={{ gap: "15px", marginBottom: "10px" }}>
        ...
        <div>
          ...
          <span
            className={`badge ${producto.estado === 1 ? "badge-active" : "badge-inactive"}`}
          >
      ...
      {producto.unidadCompraNombre && producto.unidadVentaNombre && (
        ...
        >
          ...
          <span>
            Cada 1 <b>"{producto.unidadCompraNombre}"</b> comprada se registrará
            automáticamente en stock como{" "}
            <b>
              {producto.factorConversion} "{producto.unidadVentaNombre}"
            </b>
            .
          </span>
        </div>
