...
const ModalCrearProveedor = ({ show, onClose, onRefresh }) => {
  ...
  const validarFormulario = () => {
    ...
    if (!formulario.razonSocial.trim()) {
      nuevosErrores.razonSocial =
        "Debe consultar el RUC para cargar la razón social.";
    }
    if (!formulario.nombreComercial.trim()) {
      nuevosErrores.nombreComercial =
        "Debe consultar el RUC para cargar el nombre comercial.";
    }
    if (!formulario.direccion.trim()) {
      nuevosErrores.direccion =
        "Debe consultar el RUC para cargar la dirección.";
    }
  ...
  const msgError = (campo) =>
    errores[campo] && <span style={styles.errorText}>{errores[campo]}</span>;
        ...
        <form onSubmit={handleGuardar}>
          ...
          >
            <div style={styles.formGroup}>
              ...
              <select
                ...
                style={styles.input}
                value={formulario.idTipoDocumento}
          ...
          <div style={styles.formGroup}>
            ...
            <input
              type="text"
              name="razonSocial"
              style={disabledInputStyle("razonSocial")}
              required
          ...
          <div style={styles.formGroup}>
            ...
            <input
              ...
              style={disabledInputStyle("nombreComercial")}
          ...
          <div style={styles.formGroup}>
            ...
            <input
              type="text"
              name="direccion"
              style={disabledInputStyle("direccion")}
