...
const Clientes = () => {
  ...
  const soloNumeros =
    (setter, campo, maxLen, resetDni = false) =>
    (e) => {
  ...
  const handleGuardar = async () => {
    ...
    if (!datosDni) {
      setErr("dniApi", "Primero consulta el DNI");
      return;
    }
    ...
    try {
      ...
      setErr(
        "general",
        e.response?.data?.message || "Error al registrar cliente",
      );
    } finally {
      setGuardando(false);
    }
          ...
          >
            ...
            <div style={{ padding: "18px 22px" }}>
              {[
                ...
                [
                  "Estado",
                  clienteSeleccionado.estado === 1 ? "Activo" : "Inactivo",
                ],
              ].map(([k, v]) => (
                <div
                  key={k}
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Consulta el DNI para autocompletar los datos personales
                </p>
              </div>
              <button
            ...
            <div style={{ padding: "20px 22px" }}>
              ...
              >
                <div style={grupo}>
                  ...
                  <select disabled style={{ ...inputReadonly, width: "100%" }}>
                    <option>DNI</option>
                  </select>
                </div>
                <div style={grupo}>
                ...
                <div style={grupo}>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setErr("correo", validarCorreo(e.target.value));
                    }}
                    type="email"
