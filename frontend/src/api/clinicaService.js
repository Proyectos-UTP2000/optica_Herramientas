...
export const getRecetasPorCliente = async (clienteId) => {
  return api.get(`/api/v1/recetas/cliente/${clienteId}`).then(r => extraerArray(r.data));
};
...
export const getOrdenesLaboratorio = async (estado) => {
  ...
  return api.get("/api/v1/ordenes-laboratorio", { params }).then(r => extraerArray(r.data));
};

export const getOrdenesLaboratorioPorCliente = async (clienteId) => {
  return api.get(`/api/v1/ordenes-laboratorio/cliente/${clienteId}`).then(r => extraerArray(r.data));
};

export const actualizarEstadoOrden = async (id, data) => {
  return api.put(`/api/v1/ordenes-laboratorio/${id}/estado`, data).then(r => r.data);
};
